...
function func () {
    ...
    function functor ()    {
        var _arguments  = [];
        var _current    = null;
        var _status     = 0;        // default to RUNNING, functor is the return of ascs.func
        ...
        var asyncFunc = fiber(function () {
            // `func` is asynchronous function, it will be return immediately
